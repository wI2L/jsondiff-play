        ...
        <div class="flex justify-between items-center py-3 px-6 mx-auto h-full">
            ...
            <div class="flex items-center mt-0">
                <div class="hidden items-center px-1 ml-6 h-9 bg-gray-100 dark:bg-gray-800 rounded-md ring-1 ring-gray-300 dark:ring-gray-700 md:flex">
                    <svg :class="layout === EditorLayout.OneCol ? 'active' : 'inactive'" class="mx-1 w-6 h-5 cursor-pointer" viewBox="0 0 24 20" stroke-width="1" @click.prevent="changeLayout(EditorLayout.OneCol)">
                    ...
                    <svg :class="layout === EditorLayout.TwoCols ? 'active' : 'inactive'" class="mx-1 w-6 h-5 cursor-pointer" viewBox="0 0 24 20" stroke-width="1" @click.prevent="changeLayout(EditorLayout.TwoCols)">
                    ...
                    <svg :class="layout === EditorLayout.ThreeCols ? 'active' : 'inactive'" class="hidden mx-1 w-6 h-5 cursor-pointer xl:block" viewBox="0 0 24 20" stroke-width="1" @click.prevent="changeLayout(EditorLayout.ThreeCols)">
                ...
                <div class="flex items-center px-1 h-9 bg-gray-100 dark:bg-gray-800 rounded-md ring-1 ring-gray-300 dark:ring-gray-700">
                    <span class="mx-1 text-gray-400 hover:text-gray-600 dark:text-gray-300 dark:hover:text-gray-100 cursor-pointer" @click.prevent="toggleDark()">
                        <svg v-if="isDark" class="w-6 h-6" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <svg v-else class="w-6 h-6" fill="none" preserveAspectRatio="xMidYMid meet" stroke="currentColor" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a class="mx-1 text-gray-400 hover:text-gray-600 dark:text-gray-300 dark:hover:text-gray-100" href="https://github.com/wI2L/jsondiff-play" target="_blank">
